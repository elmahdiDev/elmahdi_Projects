...
def list_resevrations_for_hotel(hotel_name):
    for reserve_info in reservation_list:
    	if reservation_list[reservation_list.index(reserve_info)][0] == hotel_name:
    		print reservation_list[reservation_list.index(reserve_info)][1]



def list_hotels_in_city(city_name):
	for hotel in hotels_list:
		if hotels_list[hotels_list.index(hotels)][2] == city_name:
			print "Hotel Name : "+hotels_list[hotels_list.index(hotels)][1]+"/n Total of rooms : "+hotels_list[hotels_list.index(hotels)][3]
